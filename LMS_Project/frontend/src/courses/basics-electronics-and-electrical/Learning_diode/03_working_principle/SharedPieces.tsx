    ...
    <g>
      {[0, 0.8, 1.6].map((delay, index) => (
        ...
        >
          ...
          <text y="6" textAnchor="middle" fontSize="18" fontWeight="900" fill="#2563eb">
            −
          </text>
        </motion.g>
      ))}
      {[0.4, 1.2, 2].map((delay, index) => (
        ...
        >
          ...
          <text y="6" textAnchor="middle" fontSize="18" fontWeight="900" fill="#dc2626">
            +
          </text>
        </motion.g>
      ))}
    ...
    <g>
      {[0, 1, 2, 3].map((index) => (
        <g key={`neg-${index}`}>
          ...
          <text x="350" y={88 + index * 34} textAnchor="middle" fontSize="18" fontWeight="900" fill="#991b1b">
            −
          </text>
        </g>
      ))}
      {[0, 1, 2, 3].map((index) => (
        <g key={`pos-${index}`}>
          ...
          <text x="410" y={88 + index * 34} textAnchor="middle" fontSize="18" fontWeight="900" fill="#1d4ed8">
            +
          </text>
        </g>
      ))}
