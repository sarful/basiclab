...
export const LABEL = addLabelOffset(
  {
    title: { x: 42, y: 320 },
    sourceTag: { x: COMPONENT.source.x, y: 500 },
    resistorTag: { x: COMPONENT.resistor.x, y: 328 },
    diodeTag: { x: COMPONENT.diode.x, y: 500 },
    outputTag: { x: COMPONENT.output.x, y: 500 },
    waveformTag: { x: 1036, y: 408 },
  },
  { x: 0, y: 0 },
);
