...
import type { MeasuringCurrentMistakeBadge } from "../useMeasuringCurrentScenario";

export default function CurrentSetupCoach({
  guidanceMessage,
  ...
  mistakeBadges: MeasuringCurrentMistakeBadge[];
}) {
  return (
