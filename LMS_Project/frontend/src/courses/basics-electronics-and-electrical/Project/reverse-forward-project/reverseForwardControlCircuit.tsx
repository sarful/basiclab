...
function ForwardBranch({
  ...
  return (
    <>
      ...
      <AuxiliaryContactNO
        x={COMPONENT.k1Hold.x}
        y={COMPONENT.k1Hold.y}
        scale={COMPONENT.k1Hold.scale}
      ...
      <WirePath
        d={PATH.forwardHold}
        state={forwardHoldClosed ? "active" : "inactive"}
      />
...
function ReverseBranch({
  ...
  return (
    <>
      ...
      <AuxiliaryContactNO
        x={COMPONENT.k2Hold.x}
        y={COMPONENT.k2Hold.y}
        scale={COMPONENT.k2Hold.scale}
      ...
      <WirePath
        d={PATH.reverseHold}
        state={reverseHoldClosed ? "active" : "inactive"}
      />
...
function FlowLayer({
  ...
  return (
    <>
      ...
      <ElectronFlow d={PATH.overloadToStop} active={commonFeedActive} />
      <ElectronFlow d={PATH.stopToForward} active={forwardPathActive} />
      <ElectronFlow d={PATH.forwardHold} active={forwardHoldClosed} />
      ...
      <ElectronFlow d={PATH.reverseHold} active={reverseHoldClosed} />
...
export default function ReverseForwardControlCircuit({
  ...
  const commonFeedActive =
    controlSupplyAvailable && !stopPressed && branchDemandActive;
  ...
  const supplyState: WireState = overloadTripped
    ? "fault"
    : mcbOn
      ? "active"
      : "inactive";

  const forwardState: WireState = forwardPathActive ? "active" : supplyState;
  const reverseState: WireState = reversePathActive ? "active" : supplyState;
