...
const NODE = {
  ...
  overloadTopTerminal: {
    x: COMPONENT.overload.x + 120,
    y: COMPONENT.overload.y + 96,
  },
  overloadBottomTerminal: {
    x: COMPONENT.overload.x + 120,
    y: COMPONENT.overload.y + 170,
  },
  ...
  holdContactRightTop: {
    x: COMPONENT.holdContact.x + 50,
    y: COMPONENT.holdContact.y - 30,
  },
  holdContactRightBottom: {
    x: COMPONENT.holdContact.x + 50,
    y: COMPONENT.holdContact.y + 70,
  },
...
const OVERLOAD_LINK = {
  topLeadEndY: COMPONENT.overload.y + 115,
  bottomLeadStartY: COMPONENT.overload.y + 149,
} as const;
...
const PATH = {
  ...
  holdingFullFlow: `M ${NODE.holdBranchTop.x} ${NODE.holdBranchTop.y} H ${NODE.holdContactRightTop.x} V ${NODE.holdContactRightBottom.y} H ${NODE.holdBranchBottom.x}`,

  startFaultPulse: `M ${NODE.offBottomTerminal.x} ${NODE.offBottomTerminal.y} V ${COMPONENT.onButton.y}`,
  ...
  return (
    <>
      ...
      <ActivePath
        ...
        state={holdingClosed ? "active" : "inactive"}
      />
      <ActivePath d={PATH.startFaultPulse} state={startFaultState} />
...
function FlowLayer({
  ...
  const currentFlowActive = coilState === "active";
  const returnFlowActive = neutralState === "active";

  return (
    <>
      <ElectronFlow
        path={PATH.neutralTopReturn}
        active={returnFlowActive && stageActive(4)}
        duration={2.8}
        staggerOffset={0.22}
      />
      <ElectronFlow
        path={PATH.liveFeed}
        active={currentFlowActive && stageActive(1)}
        duration={2.2}
      />
      <ElectronFlow
      ...
      <ElectronFlow
        path={PATH.onToCoil}
        active={currentFlowActive && stageActive(2)}
        duration={2.0}
      />
      <ElectronFlow
        path={PATH.coilBody}
        active={currentFlowActive && stageActive(3)}
        duration={1.85}
      />
      <ElectronFlow
        path={PATH.coilA2Return}
        active={returnFlowActive && stageActive(3)}
        duration={2.05}
        staggerOffset={0.02}
      />
      <ElectronFlow
        path={PATH.holdingFullFlow}
        active={holdingClosed && stageActive(4)}
        duration={2.15}
      />
      <ElectronFlow
        path={PATH.startFaultPulse}
      ...
      <ElectronFlow
        ...
        active={currentFlowActive && stageActive(4)}
        duration={1.95}
      />
      <ElectronFlow
...
function OverloadSection({
  ...
  return (
    <>
      <foreignObject
        x={COMPONENT.overload.x + 40}
        y={COMPONENT.overload.y + 72}
        width={180}
        height={120}
        overflow="visible"
      >
      ...
      <StaticLine
        x1={NODE.overloadTopTerminal.x}
        y1={NODE.overloadTopTerminal.y}
        x2={NODE.overloadTopTerminal.x}
        y2={OVERLOAD_LINK.topLeadEndY}
      />
      ...
      <ActiveLine
        ...
        x2={NODE.overloadTopTerminal.x}
        y2={OVERLOAD_LINK.topLeadEndY}
        state={controlSupplyState}
      />

      <StaticLine
        x1={NODE.overloadBottomTerminal.x}
        y1={OVERLOAD_LINK.bottomLeadStartY}
        x2={NODE.overloadBottomTerminal.x}
        y2={NODE.overloadBottomTerminal.y}
      />
  ...
  return (
    <>
      ...
      <StaticPath d={PATH.holdBottom} />
        ...
        <foreignObject
          x={COMPONENT.holdContact.x - 4}
          y={COMPONENT.holdContact.y - 54}
          width={96}
          height={168}
          overflow="visible"
      >
        ...
        >
          <NormallyOpenContactSymbol
            ...
            className={holdingClosed ? "opacity-100" : "opacity-80"}
          />
        </div>
      </foreignObject>
