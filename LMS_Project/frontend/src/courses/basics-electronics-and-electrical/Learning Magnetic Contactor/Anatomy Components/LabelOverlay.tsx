...
export default function LabelOverlay({
  ...
  width = 620,
  height = 720,
  hideInactiveDescriptions = false,
  onLabelClick,
}: LabelOverlayProps) {
  ...
  return (
    ...
    >
      {labels.map((label) => {
        ...
        const showDescription = Boolean(label.description) && (!hideInactiveDescriptions || isActive);
        const boxWidth = showDescription ? 176 : 112;
        const boxHeight = showDescription ? 58 : 34;
        ...
        return (
          ...
          >
            ...
            <text
              x={label.labelX}
              y={showDescription ? label.labelY - 10 : label.labelY + 5}
              textAnchor="middle"
              fontSize="13"
              fontWeight="700"
              fill="#111827"
