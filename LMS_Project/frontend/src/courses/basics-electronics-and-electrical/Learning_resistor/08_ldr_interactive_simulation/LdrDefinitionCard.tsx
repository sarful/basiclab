...
export function LdrDefinitionCard() {
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl">
      ...
      <div className="rounded-2xl bg-yellow-50 p-4 text-sm text-slate-700 ring-1 ring-yellow-100">
        ...
        <p className="mt-1">
          An LDR or Light Dependent Resistor changes its resistance according to
          light intensity.
        </p>
      </div>
      <div className="mt-4 rounded-2xl bg-blue-50 p-4 text-sm text-slate-700 ring-1 ring-blue-100">
        ...
        <p className="mt-1">
          In bright light the resistance becomes low, and in darkness the
