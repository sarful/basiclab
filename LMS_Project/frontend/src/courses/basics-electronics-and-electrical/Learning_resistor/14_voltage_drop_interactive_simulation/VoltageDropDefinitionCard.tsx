...
export function VoltageDropDefinitionCard() {
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl">
      ...
      <div className="rounded-2xl bg-blue-50 p-4 text-sm text-slate-700 ring-1 ring-blue-100">
        ...
        <p className="mt-1">
          Voltage drop is the voltage difference across a component where electrical
          energy is used or dissipated.
        </p>
      </div>
      <div className="mt-4 rounded-2xl bg-yellow-50 p-4 text-sm text-slate-700 ring-1 ring-yellow-100">
        ...
        <p className="mt-1">
          In a series circuit, current stays the same, but voltage is divided based
