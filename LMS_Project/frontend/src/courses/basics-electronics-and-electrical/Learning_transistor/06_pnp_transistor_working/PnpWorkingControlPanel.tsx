...
type PnpWorkingControlPanelProps = {
  controls: PnpWorkingControls;
  onChange: (patch: Partial<PnpWorkingControls>) => void;
  onReset: () => void;
};
...
export default function PnpWorkingControlPanel({
  controls,
  onChange,
  onReset,
}: PnpWorkingControlPanelProps) {
  return (
    <div className="space-y-4">
      ...
      <NumericSliderRow
        ...
        step={100}
        suffix="Ohm"
        onChange={(value) => onChange({ rbOhms: value })}
      />
