import type { FlowMode } from "./enhancementMosfetTypes";
...
export const VIEW_BOX = { x: 0, y: 0, width: 1200, height: 760 } as const;
...
export const PATH = {
  ...
  sourceRegion: "M160 325 H345 V390 Q335 425 285 425 H215 Q160 420 160 355 Z",
  drainRegion: "M840 325 H1030 V390 Q1020 425 970 425 H900 Q845 420 840 355 Z",
  channel:
...
export const MOSFET_LOGIC = {
  minGateVoltage: 0,
  maxGateVoltage: 10,
  minThresholdVoltage: 1,
  maxThresholdVoltage: 5,
  defaultThresholdVoltage: 3,
  minDrainVoltage: 0,
  maxDrainVoltage: 15,
  minTemperature: 25,
  maxTemperature: 125,
...
export const TRAINING_STEPS = [
  "MOSFET normally OFF",
  "Gate voltage reaches threshold",
  "Inversion channel forms",
  "Drain current starts",
  "Linear region",
  "Saturation and pinch-off",
] as const;

export const AUTOPLAY_STAGES: ReadonlyArray<{
  gateVoltage: number;
  drainVoltage: number;
}> = [
  { gateVoltage: 0, drainVoltage: 6 },
  { gateVoltage: 3, drainVoltage: 6 },
  { gateVoltage: 4.2, drainVoltage: 6 },
  { gateVoltage: 5.2, drainVoltage: 5 },
  { gateVoltage: 7, drainVoltage: 2 },
  { gateVoltage: 7, drainVoltage: 9 },
];

export const FLOW_MODE_OPTIONS: FlowMode[] = [
  "Electron",
  "Conventional",
  "Both",
];
