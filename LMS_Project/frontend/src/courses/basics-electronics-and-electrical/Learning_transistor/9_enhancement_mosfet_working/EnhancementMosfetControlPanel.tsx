...
import EnhancementMosfetDualChannelOscilloscope from "./EnhancementMosfetDualChannelOscilloscope";
import { FLOW_MODE_OPTIONS, MOSFET_LOGIC, TRAINING_STEPS } from "./enhancementMosfetConstants";
...
export type EnhancementMosfetControlPanelProps = {
  autoScale: boolean;
  drainCurrent: number;
  gateVoltage: number;
  drainVoltage: number;
  ...
  setThresholdVoltage: (value: number) => void;
...
export default function EnhancementMosfetControlPanel({
  autoScale,
  drainCurrent,
  gateVoltage,
  drainVoltage,
  ...
  onReset,
  onAuto,
}: EnhancementMosfetControlPanelProps) {
  return (
    <aside className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_16px_40px_rgba(15,23,42,0.06)] xl:sticky xl:top-6">
      <div className="mb-5">
        ...
        <h2 className="mt-2 text-2xl font-black text-slate-900">Enhancement MOSFET Inputs</h2>
        <p className="mt-2 text-sm leading-6 text-slate-500">
          Match lesson 14 style and tune gate, drain, threshold, load, and learning flow from one left-side panel.
        </p>
      </div>
      ...
      <div className="grid gap-4">
        ...
        <RangeControl
          label="Drain Voltage"
          value={drainVoltage}
          min={MOSFET_LOGIC.minDrainVoltage}
          max={MOSFET_LOGIC.maxDrainVoltage}
          step={0.1}
          unit="V"
        ...
        <RangeControl
          ...
          min={MOSFET_LOGIC.minThresholdVoltage}
          max={MOSFET_LOGIC.maxThresholdVoltage}
          step={0.1}
          unit="V"
          onChange={setThresholdVoltage}
        />
        <RangeControl
          label="Load Resistance"
          value={loadResistance}
          min={MOSFET_LOGIC.minLoadResistance}
          max={MOSFET_LOGIC.maxLoadResistance}
          step={10}
          unit="Ohm"
        ...
        <RangeControl
          label="Temperature"
          value={temperature}
          min={MOSFET_LOGIC.minTemperature}
          max={MOSFET_LOGIC.maxTemperature}
          step={1}
          unit="C"
        ...
        <EnhancementMosfetDualChannelOscilloscope
          autoScale={autoScale}
