...
export default function Lesson09RegulatorWithRectifierAndFilterPlanningScaffold() {
  return (
    <PlanningLessonSection
      ...
      status="Partial"
      folderName="Learning_voltage_regulator/09_regulator_with_rectifier_and_filter"
