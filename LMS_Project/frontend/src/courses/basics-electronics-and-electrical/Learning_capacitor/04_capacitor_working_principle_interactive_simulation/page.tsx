...
import CapacitorLessonFourSimulation from "./CapacitorLessonFourSimulation";
import LogicTheoryBanglaTab from "./LogicTheoryBanglaTab";
import LogicTheoryTab from "./LogicTheoryTab";

export default function CapacitorLessonFourEmbeddedPage() {
  const lessonPanel = (
    <section
      style={{
        borderRadius: 32,
    ...
    >
      ...
      >
        ...
        <CapacitorLessonFourSimulation embedded />
      </div>
    </section>
  );
  ...
  return (
    <CapacitorLessonEmbeddedShell
      lessonId={4}
      lessonTitle="Capacitor Working Principle"
      lessonContent={{
