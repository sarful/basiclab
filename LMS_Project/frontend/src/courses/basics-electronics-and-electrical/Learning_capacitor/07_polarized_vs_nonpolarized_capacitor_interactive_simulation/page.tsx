...
import CapacitorLessonSevenSimulation from "./CapacitorLessonSevenSimulation";
import LogicTheoryBanglaTab from "./LogicTheoryBanglaTab";
import LogicTheoryTab from "./LogicTheoryTab";

export default function CapacitorLessonSevenEmbeddedPage() {
  const lessonPanel = (
    <section
      style={{
        borderRadius: 32,
    ...
    >
      ...
      >
        ...
        <CapacitorLessonSevenSimulation embedded />
      </div>
    </section>
  );
  ...
  return (
    <CapacitorLessonEmbeddedShell
      lessonId={7}
      lessonTitle="Polarized vs Nonpolarized Capacitor"
      lessonContent={{
