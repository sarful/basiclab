...
const TIMELINE_STEPS = [
  {
    ...
    description:
      "Input signal is ready, but the LED has not started optical triggering.",
  },
  {
    id: 1,
    label: "LED ON",
  ...
  },
  {
    ...
    title: "Light triggers the PhotoTRIAC",
    description:
      "Light crosses the isolation barrier and gates the PhotoTRIAC output device.",
  },
  {
    id: 3,
    label: "AC Load ON",
    title: "AC pilot light conducts",
    description:
      "The isolated AC output path turns on and current flows through the pilot light load.",
  },
