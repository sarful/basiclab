...
const ControlPanel = ({
  ...
  return (
    <div
      className="w-full rounded-3xl border border-slate-200 bg-white p-4 shadow-sm ring-1 ring-slate-100"
      style={{
    ...
    >
      <div className="mb-4 rounded-2xl bg-slate-950 p-4 text-white">
        ...
        <h3 className="mt-1 text-xl font-black">SSR With Circuit</h3>
...
export function Relay({
  ...
  const handleTimeCursorChange = (nextProgress: number) => {
    ...
    setSimulationStep(getStepFromProgress(normalizedProgress));
  };
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 rounded-[28px] border border-slate-200 bg-slate-50/70 p-4 sm:p-5">
        ...
        <div className="mx-auto flex w-fit max-w-full justify-center overflow-hidden rounded-3xl border border-slate-200 bg-white p-3 shadow-sm">
          <svg
