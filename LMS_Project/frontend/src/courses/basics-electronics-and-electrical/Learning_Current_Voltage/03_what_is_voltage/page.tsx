...
import CurrentVoltageLessonThreeSimulation from "./CurrentVoltageLessonThreeSimulation";
...
export default function CurrentVoltageLessonThreeEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonThreeTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonThreeTab>[],
    "lesson",
  );
  ...
  function renderPlaceholder(title: string) {
    return (
      ...
      >
        ...
        >
          This section is the next part of the What is Voltage lesson build. The
          shared lesson shell and course navigation are now ready, and this tab
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={3} />
            </div>
            {activeTab === "lesson" ? <CurrentVoltageLessonThreeSimulation /> : null}
