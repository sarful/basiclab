...
import CurrentVoltageLessonFiveSimulation from "./CurrentVoltageLessonFiveSimulation";
...
function InProgressTab({ title }: { title: string }) {
  return (
    ...
    >
      ...
      >
        This section is the next part of the Types of Voltage lesson build. The
...
export default function CurrentVoltageLessonFifteenTypesOfVoltageEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonFifteenTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonFifteenTab>[],
    "lesson",
  );
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={15} />
            </div>

            {activeTab === "lesson" ? <CurrentVoltageLessonFiveSimulation /> : null}
