...
import CurrentVoltageLessonEightShortCircuitSimulation from "./CurrentVoltageLessonEightShortCircuitSimulation";
...
function InProgressTab({ title }: { title: string }) {
  return (
    ...
    >
      ...
      >
        This section is the next part of the Short Circuit Basics lesson build.
...
export default function CurrentVoltageLessonEightShortCircuitEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonEightTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonEightTab>[],
    "lesson",
  );
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={8} />
            </div>

            {activeTab === "lesson" ? <CurrentVoltageLessonEightShortCircuitSimulation /> : null}
