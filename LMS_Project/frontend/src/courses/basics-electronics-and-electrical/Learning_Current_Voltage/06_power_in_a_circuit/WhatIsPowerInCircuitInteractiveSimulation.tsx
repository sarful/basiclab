          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-amber-800">
                Power increases when voltage increases, current increases, or
            ...
            <div className="rounded-2xl border border-amber-200 bg-white px-4 py-3 lg:max-w-[420px]">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-700">
                More push or more flow usually means more power, because the
                circuit is doing more work each second.
              </p>
            </div>
          </div>
        </section>
          ...
          <section className="space-y-4">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white/95 p-5 shadow-[0_18px_44px_rgba(15,23,42,0.08)] backdrop-blur md:p-6">
              ...
              <p className="mt-3 max-w-3xl text-[0.98rem] leading-7 text-slate-600 md:text-[1rem]">
                This simulation shows how one result depends on voltage and
                current together. As those values change, the power level
                changes too.
              </p>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                <div className="rounded-2xl border border-orange-200 bg-orange-50 p-4">
                  ...
                  <p className="mt-2 text-[1.8rem] font-semibold text-orange-800">
                    {powerLevel}
                  </p>
                  <p className="mt-2 text-sm leading-6 text-orange-700/80">
                    Higher power means the circuit is using electrical energy
                    faster.
                  </p>
                </div>
              ...
              <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5">
                ...
                <p className="mt-2 text-[0.98rem] leading-7 text-slate-600">
                  Power is not a separate mystery value. It is simply the result
                  of voltage and current working together inside the circuit.
                </p>
              </div>
            </section>
          </section>
