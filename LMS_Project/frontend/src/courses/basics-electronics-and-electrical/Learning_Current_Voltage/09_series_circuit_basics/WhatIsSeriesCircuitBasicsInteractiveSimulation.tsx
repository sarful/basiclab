          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-blue-800">
                The same current flows through every component, while the
                voltage is shared across the parts in the loop.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3 lg:max-w-[420px]">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-700">
                One path means the same current in every part, while the voltage
                is shared across the loop.
              </p>
            </div>
          </div>
        </section>
          ...
          <section className="space-y-4">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white/95 p-5 shadow-[0_18px_44px_rgba(15,23,42,0.08)] backdrop-blur md:p-6">
              ...
              <p className="mt-3 max-w-3xl text-[0.98rem] leading-7 text-slate-600 md:text-[1rem]">
                This simulation shows how one complete series loop shares the
                same current through every part while the voltage drop is
                divided across the components.
              </p>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-blue-700/80">
                    The same current moves through resistor one, resistor two,
                    and the LED.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Adding more series resistance makes the total loop
                    resistance larger.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-green-200 bg-green-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-green-700/80">
                    The voltage drops across the resistors add up around the
                    loop.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5">
                ...
                <p className="mt-2 text-[0.98rem] leading-7 text-slate-600">
                  In a series circuit, the path is one line. Because of that,
                  current stays the same everywhere, while resistance adds up
                  and the voltage drop gets shared across the parts.
                </p>
              </div>
            </section>
          </section>
