...
import CurrentVoltageLessonSevenOpenClosedSimulation from "./CurrentVoltageLessonSevenOpenClosedSimulation";
...
function InProgressTab({ title }: { title: string }) {
  return (
    ...
    >
      ...
      >
        This section is the next part of the Open Circuit vs Closed Circuit
...
export default function CurrentVoltageLessonSevenOpenClosedEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonSevenTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonSevenTab>[],
    "lesson",
  );
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={7} />
            </div>

            {activeTab === "lesson" ? <CurrentVoltageLessonSevenOpenClosedSimulation /> : null}
