...
import CurrentVoltageLessonFourResistanceSimulation from "./CurrentVoltageLessonFourResistanceSimulation";
...
export default function CurrentVoltageLessonFourResistanceEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonFourTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonFourTab>[],
    "lesson",
  );
  ...
  function renderPlaceholder(title: string) {
    return (
      ...
      >
        ...
        >
          This section is the next part of the What is Resistance lesson build.
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={4} />
            </div>
            {activeTab === "lesson" ? <CurrentVoltageLessonFourResistanceSimulation /> : null}
