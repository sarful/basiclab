          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-amber-800">
                More resistance means less current flow. Less resistance means
                current can move more easily through the circuit.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-amber-200 bg-white px-4 py-3 lg:max-w-[420px]">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-700">
                More resistance means more opposition. If voltage stays the
                same, that stronger opposition usually reduces current.
              </p>
            </div>
          </div>
        </section>
          ...
          <section className="space-y-4">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white/95 p-5 shadow-[0_18px_44px_rgba(15,23,42,0.08)] backdrop-blur md:p-6">
              ...
              <p className="mt-3 max-w-3xl text-[0.98rem] leading-7 text-slate-600 md:text-[1rem]">
                In this lesson, resistance is the opposition inside the path. As
                you raise resistance, charge has a harder time moving. As you
                lower it, the path becomes easier for current to use.
              </p>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-blue-700/80">
                    This shows how hard the circuit is pushing back against
                    charge movement.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    {voltage.toFixed(1)} / {resistance.toFixed(1)} ={" "}
                    {current.toFixed(2)} A
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-green-200 bg-green-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-green-700/80">
                    The resistor protects the circuit by limiting how much
                    current can move.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4 md:p-5">
                ...
                <p className="mt-2 text-[0.98rem] leading-7 text-slate-600">
                  When voltage stays the same, increasing resistance makes
                  current smaller. Lower resistance gives charge an easier path,
                  so current rises more easily.
                </p>
              </div>
            </section>
          </section>
