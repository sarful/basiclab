...
import CurrentVoltageLessonTenParallelCircuitSimulation from "./CurrentVoltageLessonTenParallelCircuitSimulation";
...
function InProgressTab({ title }: { title: string }) {
  return (
    ...
    >
      ...
      >
        This section is the next part of the Parallel Circuit Basics lesson
...
export default function CurrentVoltageLessonTenParallelCircuitEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonTenTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonTenTab>[],
    "lesson",
  );
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={10} />
            </div>

            {activeTab === "lesson" ? (
              <CurrentVoltageLessonTenParallelCircuitSimulation />
            ) : null}
