  ...
  const quizItems: QuizAccordionItem[] = [
    {
      ...
      answer:
        "Current means the amount of electric charge moving through the circuit.",
    },
    {
    ...
    {
      question:
        "What usually happens to current if voltage goes up and resistance stays the same?",
      answer:
        "Current usually increases because the electrical push becomes stronger.",
    },
    {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-lg font-medium leading-7 text-slate-800">
              Current is the amount of electric charge moving through a complete
              path.
            </p>
            ...
            <p className="mt-2 max-w-3xl text-base leading-7 text-slate-600">
              ...
              through a pipe. More push gives more flow. More blockage gives
              less flow.
            </p>
          </div>
      ...
      <SectionCard title="What is it?" eyebrow="Core Concept">
        <p>Current is the flow of electric charge through a circuit.</p>
        <p>
          In simple English, current tells us how much charge is actually
          moving. If more charge passes through the wire each second, current is
          higher.
        </p>
        <p>
      ...
      <SectionCard title="Why is it important?" eyebrow="Why It Matters">
        ...
        <p>
          <strong>What to notice:</strong> A device may have voltage present,
          but without enough current it still may not work properly.
        </p>
        <p>
          <strong>
      ...
      <SectionCard title="How does it work?" eyebrow="How It Works">
        <p>Current depends mainly on two things: voltage and resistance.</p>
        <p>
        ...
        <p>
          A common beginner mistake is to think current and voltage mean the
          same thing. They do not. Voltage is the push. Current is the flow that
        ...
        <div className="p-5 md:p-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              <div className="mt-4 space-y-3 text-[15px] leading-8 text-slate-700 md:text-[16px]">
                <p>Think about a torch light again.</p>
                <p>
                ...
                <p>
                  ...
                  the path breaks, current stops. If resistance becomes too
                  high, the bulb becomes dim.
                </p>
                <p>
