...
export function RangeControl({
  ...
  const accentClass = tone === "red" ? "accent-red-600" : "accent-slate-600";
...
export function StatusBox({ label, value, tone }: { label: string; value: string; tone: "red" | "blue" | "slate" }) {
  const color = tone === "red" ? "border-red-300 bg-red-50 text-red-700" : tone === "blue" ? "border-blue-300 bg-blue-50 text-blue-700" : "border-slate-300 bg-slate-50 text-slate-700";
...
export function MetricCard({ title, value, detail, tone }: { title: string; value: string; detail: string; tone: "blue" | "green" | "slate" }) {
  const color = tone === "blue" ? "border-blue-200 bg-blue-50 text-blue-800" : tone === "green" ? "border-green-200 bg-green-50 text-green-800" : "border-slate-200 bg-slate-50 text-slate-800";
