...
import CurrentVoltageLessonSixSimulation from "./CurrentVoltageLessonSixSimulation";
...
function InProgressTab({ title }: { title: string }) {
  return (
    ...
    >
      ...
      >
        This section is the next part of the Electron Flow lesson build. The
...
export default function CurrentVoltageLessonTwelveElectronFlowEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonTwelveTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonTwelveTab>[],
    "lesson",
  );
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={12} />
            </div>

            {activeTab === "lesson" ? <CurrentVoltageLessonSixSimulation /> : null}
