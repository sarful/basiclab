...
import CurrentVoltageLessonFiveOhmsLawSimulation from "./CurrentVoltageLessonFiveOhmsLawSimulation";
...
export default function CurrentVoltageLessonFiveOhmsLawEmbeddedPage() {
  const { activeTab, setActiveTab, tabs } = useAuthorizedLessonTabs<LessonFiveTab>(
    [
    ...
    ] satisfies LessonShellTab<LessonFiveTab>[],
    "lesson",
  );
        ...
        >
          ...
          <div style={{ padding: "28px 22px 22px", background: "#f8fafc" }}>
            <div style={{ marginBottom: 22 }}>
              <CurrentVoltageCourseNav currentLessonId={5} />
            </div>
            {activeTab === "lesson" ? <CurrentVoltageLessonFiveOhmsLawSimulation /> : null}
