    ...
    <div className="space-y-4">
      <section className="rounded-[36px] border border-slate-200 bg-white p-10 shadow-[0_18px_44px_rgba(15,23,42,0.10)]">
        ...
        <p className="mt-4 max-w-4xl text-base leading-8 text-slate-600">
          ...
          beginner-friendly video recording.
        </p>
      </section>
      ...
      <ScriptBlock title="Lesson Goal" cue="Before Recording">
        ...
        <p>
          ...
          charge through a complete closed path.
        </p>
        <p>They should also understand four basic ideas.</p>
        <p>Electrons carry charge in metal wires.</p>
      ...
      <ScriptBlock title="Scene 1: Opening" cue="Intro">
        ...
        <p>We will keep it simple, clear, and step by step.</p>
        <EmphasisLine>
          In one short sentence, electricity is the flow of electric charge
          through a complete closed path.
        </EmphasisLine>
      </ScriptBlock>
      ...
      <ScriptBlock title="Scene 2: Explain the Basic Idea" cue="Teach Slowly">
        ...
        <p>
          In metal wires, tiny particles called electrons carry electric charge.
        </p>
        <p>If the path is broken, charge cannot keep moving.</p>
        <p>If the path is complete and closed, charge can flow.</p>
        <PauseCue label="Emphasize" />
        <EmphasisLine>
          Electricity needs a complete closed circuit path.
        </EmphasisLine>
      </ScriptBlock>
      ...
      <ScriptBlock
        title="Scene 5: Show the Current Value"
        cue="Point to Current"
      >
        <p>The result of that movement is called current.</p>
        <PauseCue label="Point to Current" />
        <p>Current tells us how much electric charge is actually flowing.</p>
      ...
      <ScriptBlock title="Scene 6: Water Analogy" cue="Use Analogy">
        ...
        <p>Current is like the amount of water actually flowing.</p>
        <p>
          Resistance is like a narrow pipe that makes water harder to push
          through.
        </p>
        <EmphasisLine>
          This analogy helps beginners picture what is happening inside the
          circuit.
        </EmphasisLine>
      </ScriptBlock>

      <ScriptBlock
        title="Scene 7: Real-World Example"
        cue="Connect to Real Life"
      >
        <p>Think about a simple torch light.</p>
        <PauseCue label="Give Example" />
        <p>If the switch is open, the path is broken.</p>
        <p>Because the path is broken, charge cannot flow properly.</p>
        <p>So the lamp does not turn on.</p>
        <p>If the switch is closed, the path becomes complete.</p>
        <p>Then charge can move through the lamp, and the lamp turns on.</p>
        <p>
          The same basic idea is used in home lighting, control panels, sensors,
          and many electronic devices.
        </p>
      </ScriptBlock>

      <ScriptBlock title="Scene 8: Safety Note" cue="Important">
        <p>Before we continue, remember one important safety point.</p>
        <PauseCue label="Emphasize Safety" />
        <p>This lesson is only for understanding the basic concept.</p>
        <p>
          Real electrical systems can be dangerous if handled without proper
          knowledge and safety rules.
        </p>
        <EmphasisLine>
          Always follow proper electrical safety practices in real work.
        </EmphasisLine>
      </ScriptBlock>
      ...
      <ScriptBlock title="Scene 9: Short Recap" cue="Recap">
        ...
        <p>A complete closed path is required.</p>
        <p>Electrons carry charge in metal wires.</p>
        <p>Voltage gives the push.</p>
        <p>Resistance slows the movement.</p>
        <p>Current shows the actual flow.</p>
      ...
      <ScriptBlock title="Scene 10: Closing" cue="End">
        ...
        <EmphasisLine>
          Electricity is the movement of charge through a complete closed path.
        </EmphasisLine>
        <p>Once you understand this idea, basic electronics becomes easier.</p>
      ...
      <ScriptBlock title="Full Teleprompter Version" cue="Read Directly">
        ...
        <p>
          Electric charge needs a path to move. In metal wires, tiny particles
          called electrons carry electric charge. If the path is broken, charge
          cannot keep moving. If the path is complete and closed, charge can
          flow.
        </p>
        ...
        <p>
          ...
          The source gives voltage. Voltage means electrical push. This push
          tries to move charge through the circuit.
        </p>

        <p>
          Next, look at the resistor. Resistance makes it harder for charge to
          move. So voltage pushes, and resistance slows.
        </p>

        <p>
          The result of this movement is called current. Current tells us how
          much electric charge is actually flowing. In this lesson, the battery
          gives 12 volts. The resistor is 6 ohms. Because of that combination,
          the current becomes 2 amps.
        </p>

        <p>
          Here is a simple way to imagine it. Think about water moving through a
          pipe. Voltage is like water pressure. Current is like the amount of
          water actually flowing. Resistance is like a narrow pipe that makes
          water harder to push through.
        </p>

        <p>
          Now think about a simple torch light. If the switch is open, the path
          is broken, so the lamp does not turn on. If the switch is closed, the
          path becomes complete. Then charge can move through the lamp, and the
          lamp turns on.
        </p>

        <p>
          One important note: this lesson is only for understanding the basic
          concept. Real electrical systems can be dangerous if handled without
          proper knowledge and safety rules.
        </p>

        <p>
          So let us quickly recap. Electricity is the flow of electric charge. A
          complete closed path is required. Electrons carry charge in metal
          wires. Voltage gives the push. Resistance slows the movement. Current
        ...
        <p>
          So the main idea is simple: electricity is the movement of charge
          through a complete closed path. Once you understand this idea, basic
          electronics becomes easier. In the next lesson, we will build on this
          foundation.
        </p>
      </ScriptBlock>
    </div>
