...
const WIRE_OFFSET: Record<WireId, Point> = {
  ...
  nTopBus: { x: 0, y: 0 },
  nBottomBus: { x: 0, y: 0 },
  nTopBusToSourceTop: { x: 0, y: 0 },
  nSourceBottomToBottomBus: { x: 0, y: 0 },
  nTopBusToRnTop: { x: 0, y: 0 },
  nRnBottomToBottomBus: { x: 0, y: 0 },
  nTopBusToLoadRTop: { x: 0, y: 0 },
  nLoadRBottomToBottomBus: { x: 0, y: 0 },
};
...
const NORTON = {
  ...
  topBusRn: { x: 890, y: 150 },
  topBusLoad: { x: 1045, y: 150 },

  bottomBusLeft: { x: 735, y: 560 },
  bottomBusRn: { x: 890, y: 560 },
  bottomBusLoad: { x: 1045, y: 560 },
...
const WIRE_SEGMENTS: Array<{
  ...
  // Norton top and bottom buses
  { id: 'nTopBus', from: NORTON.topBusLeft, to: NORTON.topBusLoad },
  { id: 'nBottomBus', from: NORTON.bottomBusLeft, to: NORTON.bottomBusLoad },

  // Norton current source branch
  { id: 'nTopBusToSourceTop', from: NORTON.topBusLeft, to: NORTON.sourceTop },
  { id: 'nSourceBottomToBottomBus', from: NORTON.sourceBottom, to: NORTON.bottomBusLeft },

  // Norton RN branch
  { id: 'nTopBusToRnTop', from: NORTON.topBusRn, to: NORTON.rnTop },
  { id: 'nRnBottomToBottomBus', from: NORTON.rnBottom, to: NORTON.bottomBusRn },

  // Norton load branch
  { id: 'nTopBusToLoadRTop', from: NORTON.topBusLoad, to: NORTON.loadRTop },
  { id: 'nLoadRBottomToBottomBus', from: NORTON.loadRBottom, to: NORTON.bottomBusLoad },
];
...
const DEBUG_TERMINALS = [
  ...
  ['N-TopBus-L', NORTON.topBusLeft],
  ['N-TopBus-Rn', NORTON.topBusRn],
  ['N-TopBus-A', NORTON.topBusLoad],
  ['N-BottomBus-L', NORTON.bottomBusLeft],
  ['N-BottomBus-Rn', NORTON.bottomBusRn],
  ['N-BottomBus-B', NORTON.bottomBusLoad],
...
function solveNorton(values: CircuitValues): NortonResult {
  ...
  // Original loaded circuit verification.
          ...
          : viewMode === 'equivalent'
            ...
            : viewMode === 'practice'
              ...
              : [
                  ...
                  { color: COLOR.wire, text: 'No diagonal cursed wires' },
