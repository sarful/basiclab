...
export default function TransformerLearningIndexPage() {
  const track = getLessonTrackConfig("transformer");
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {track.summary} Open any lesson below to continue through the current
            transformer roadmap.
          </p>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the current transformer roadmap
              </h2>
            </div>
