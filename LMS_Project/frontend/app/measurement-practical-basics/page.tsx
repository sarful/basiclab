...
export default function MeasurementPracticalBasicsIndexPage() {
  const track = getLessonTrackConfig("measurement-practical");
      ...
      >
        ...
        >
          ...
          >
            ...
            measurement and practical roadmap.
          </p>
          ...
          >
            {firstLesson ? (
              <Link
                ...
                style={{
                  ...
                  fontWeight: 700,
                  textDecoration: "none",
                  boxShadow: "0 10px 24px rgba(8,145,178,0.24)",
                }}
              >
            ...
            <a
              href="#measurement-practical-lesson-list"
              style={{
                display: "inline-flex",
                alignItems: "center",
                justifyContent: "center",
        ...
        <section
          id="measurement-practical-lesson-list"
          style={{
            borderRadius: 28,
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the practical measurement roadmap
              </h2>
            </div>
