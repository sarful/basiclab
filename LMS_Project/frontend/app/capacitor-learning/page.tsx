...
export default function CapacitorLearningPage() {
  const track = getLessonTrackConfig("capacitor");
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the capacitor roadmap
              </h2>
            </div>
