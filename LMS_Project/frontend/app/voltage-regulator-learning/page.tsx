...
export default function VoltageRegulatorLearningPage() {
  const track = getLessonTrackConfig("voltage-regulator");
      ...
      >
        ...
        >
          ...
          >
            ...
            regulation and power-supply roadmap.
          </p>
          ...
          >
            ...
            <a
              href="#voltage-regulator-lesson-list"
              style={{
                display: "inline-flex",
                alignItems: "center",
                justifyContent: "center",
        ...
        <section
          id="voltage-regulator-lesson-list"
          style={{
            borderRadius: 28,
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the regulator roadmap
              </h2>
            </div>
