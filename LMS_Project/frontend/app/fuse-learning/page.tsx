...
export default function FuseLearningPage() {
  const track = getLessonTrackConfig("fuse");
            ...
            {firstLesson ? (
              <Link
                ...
                style={{
                  ...
                  fontWeight: 700,
                  textDecoration: "none",
                  boxShadow: "0 10px 24px rgba(234,179,8,0.24)",
                }}
              >
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the fuse roadmap
              </h2>
            </div>
