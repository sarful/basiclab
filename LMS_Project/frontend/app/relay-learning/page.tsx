...
export default function RelayLearningPage() {
  const track = getLessonTrackConfig("relay");
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the relay roadmap
              </h2>
            </div>
