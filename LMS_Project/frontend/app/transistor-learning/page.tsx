...
export default function TransistorLearningIndexPage() {
  const track = getLessonTrackConfig("transistor");
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {track.summary} Open any lesson below to continue from the transistor topics
            that are currently active in this track.
          </p>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the current transistor roadmap
              </h2>
            </div>
