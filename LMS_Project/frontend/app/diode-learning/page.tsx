...
export default function DiodeLearningPage() {
  const track = getLessonTrackConfig("diode");
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the diode roadmap
              </h2>
            </div>
