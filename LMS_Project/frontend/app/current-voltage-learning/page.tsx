...
export default function CurrentVoltageLearningIndexPage() {
  const track = getLessonTrackConfig("current-voltage");
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              href="#current-voltage-lesson-list"
              style={{
                display: "inline-flex",
                alignItems: "center",
                justifyContent: "center",
        ...
        <section
          id="current-voltage-lesson-list"
          style={{
            borderRadius: 28,
        ...
        >
          ...
          >
            <div>
              ...
              >
                Continue with the current & voltage roadmap
              </h2>
            </div>
