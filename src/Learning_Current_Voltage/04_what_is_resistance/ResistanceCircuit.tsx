...
export function ResistanceCircuit({
  voltage,
  resistance,
  current,
  flowPercent,
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="What is resistance circuit"
    >
      <defs>
        <filter
          id="electricityGlow"
      ...
      <text x="224" y="124" fontSize="13" fontWeight="700" fill={POSITIVE_WIRE}>
        Voltage Push
      </text>
      <text x="426" y="296" fontSize="13" fontWeight="700" fill={FLOW_COLOR}>
        Charge Flow {"->"}
      </text>
