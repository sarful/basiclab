...
export default function PushButtonNO({
  x = 0,
  y = 0,
  scale = 1,
  pressed = false,
  ...
  const symbol = (
    ...
    >
      ...
      {pressed ? (
        <path d="M15 10h20" strokeWidth={cableStroke} />
      ) : (
        <path d="M15 5h20" strokeWidth={cableStroke} />
      )}
      <path d={pressed ? "M25 5v5" : "M25 0v5"} strokeWidth={cableStroke} />
