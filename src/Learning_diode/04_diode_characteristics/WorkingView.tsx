...
export function WorkingView({ bias, voltage }: { bias: BiasMode; voltage: number }) {
  ...
  return (
    <div className="rounded-xl border border-slate-300 bg-white shadow-sm">
      <svg viewBox="0 0 760 330" className="h-[330px] w-full" role="img" aria-label="Diode working principle circuit">
        ...
        <text x="90" y="143" textAnchor="middle" fontSize="30" fontWeight="700" fill={isForward ? "#dc2626" : "#111827"}>{isForward ? "+" : "−"}</text>
        <text x="90" y="180" textAnchor="middle" fontSize="30" fontWeight="700" fill={isForward ? "#111827" : "#dc2626"}>{isForward ? "−" : "+"}</text>
        ...
        <text x="280" y="72" fontSize="18" fontWeight="800" fill="#dc2626">+</text>
        <text x="360" y="72" fontSize="18" fontWeight="800" fill="#111827">−</text>
        ...
        <text x="250" y="292" fontSize="14" fontWeight="700" fill="#334155">
