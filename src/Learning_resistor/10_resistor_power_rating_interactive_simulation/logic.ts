...
export function getStatus(power: number, rating: number) {
  ...
  if (ratio >= 0.75) return { label: "HOT / CAUTION", tone: "text-orange-600", bg: "bg-orange-50 border-orange-200", message: "Close to the limit — choose a higher wattage for safety." };
