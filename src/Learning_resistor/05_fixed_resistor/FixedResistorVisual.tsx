    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-xl sm:p-5">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-xs text-slate-600">Fixed value, tolerance এবং power rating-এর effect live দেখুন।</p>
        </div>

        <span className={`rounded-full px-3 py-1 text-xs font-bold ${isOverloaded ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}>
      ...
      <div className="overflow-x-auto rounded-2xl bg-gradient-to-b from-slate-50 to-white p-3">
        <svg viewBox="0 0 760 340" className="h-auto w-[760px] sm:w-full">
          ...
          <line x1="50" y1="165" x2="180" y2="165" stroke="#64748b" strokeWidth={5 + clamp(current * 50, 0, 6)} strokeLinecap="round" />
          <line x1="580" y1="165" x2="710" y2="165" stroke="#64748b" strokeWidth={5 + clamp(current * 50, 0, 6)} strokeLinecap="round" />
          ...
          <rect x="225" y="135" width="310" height="58" rx="28" fill={type.layerColor} opacity="0.18" stroke={type.layerColor} strokeDasharray="6 6" />
          ...
          <g transform="translate(160 305)">
            ...
            <motion.rect x="0" y="10" height="10" rx="5" fill={isOverloaded ? "#ef4444" : "#22c55e"} animate={{ width: 440 * clamp(powerLoad, 0, 1) }} />
          </g>
        </svg>
      </div>
    </div>
